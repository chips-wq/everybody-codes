...
def swap_trees(n1 : Node, n2 : Node):
  print(f"Starting swapping trees n1 = {n1.symbol}, n2 = {n2.symbol}")
  assert n1.parent and n2.parent
  ...
  print(f"Finished swapping trees")
...
if __name__ == "__main__":
  ...
  for line in open(infile):
    ...
    if line[:3] == "ADD":
      ...
      print("Started adding node")
      left_tree = add_node(left_tree, left_node)
      right_tree = add_node(right_tree, right_node)
      print("Finsished adding node")
    else:
      _, cid =  line.split(" ")
      cid = int(cid)
      
      swap_trees(d1[cid][0], d1[cid][1])
